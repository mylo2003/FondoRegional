...
public class KohaDatabaseConfig {
    ...
    @Bean(name = "kohaDatasource")
    @ConfigurationProperties(prefix = "koha.datasource")
    public DataSource dataSource() {
        return DataSourceBuilder.create().build();
    }

    @Bean(name = "kohaEntityManagerFactory")
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(
            @Qualifier("kohaDatasource") DataSource dataSource) {
    ...
    @Bean("kohaTransactionManager")
    public PlatformTransactionManager platformtransactionManager(
            @Qualifier("kohaEntityManagerFactory") EntityManagerFactory entityManagerFactory
    ) {
